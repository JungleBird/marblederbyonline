...
//TODO: implement the displayTrigger prop
export function TextSequenceEvent({
  displayText = "example text",
  displayTrigger = { type: "event", id: "exampleEvent"},
  animationDuration = 3,
  staticDuration = 1,
  delay = 1,
}) {
  ...
  //use regex to sanitize displayText and trim it to max 30 characters
  const safeDisplayText = displayText.replace(/[^a-zA-Z0-9\s.,!?'-]/g, "").substring(0, 30);
