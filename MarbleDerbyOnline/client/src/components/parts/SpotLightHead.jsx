...
import { SpotLight, Line } from "@react-three/drei";
...
export function OrientedSpotLightHead({
  position,
  targetPosition,
  color = "#ffffff",
}) {
...
export function AnimatedSpotLight({
  ...
  useFrame((state, delta) => {
    const targetIntensity = triggerFlag ? maxIntensity : 0;
    const targetOpacity = triggerFlag ? 0.5 : 0;

    // Linear interpolation over ~1 second
    const stepI = maxIntensity * delta;
